...
export default function DashboardPage() {
  ...
  return (
    <div className="mx-auto max-w-3xl px-5 py-8 md:py-14 lg:max-w-5xl">
      {/* Greeting */}
      <div className="mb-8 flex items-start justify-between">
        <div>
          <p className="text-xs uppercase tracking-[0.2em] text-gold/60">
            {isEnterprise ? "Corporate Command Center" : "My Celebrations"}
          </p>
          ...
          <p className="mt-1 text-sm text-ivory/40">
            {isEnterprise
              ? "Your staff registry & standing orders — never miss a celebration again"
              : "Your family vault — keeping track of the people who matter"}
          </p>
        </div>
        <button
      ...
      <div className="flex flex-col gap-6 lg:flex-row lg:gap-8">
        ...
        <div className="lg:w-[320px] lg:shrink-0">
          {/* Stats */}
          <div className="mb-4 grid grid-cols-3 gap-3 lg:grid-cols-1">
            <div className="rounded-xl border border-gold/10 bg-gold/[0.03] p-4 text-center lg:flex lg:items-center lg:gap-4 lg:text-left">
              <CalendarDays size={18} className="mx-auto mb-1 text-gold/50 lg:mx-0 lg:mb-0" />
              <div>
            ...
            <div className="rounded-xl border border-gold/10 bg-gold/[0.03] p-4 text-center lg:flex lg:items-center lg:gap-4 lg:text-left">
              <Gift size={18} className="mx-auto mb-1 text-teal/50 lg:mx-0 lg:mb-0" />
              <div>
                <p className="text-xl font-bold text-ivory tabular-nums">
            ...
            <div className="rounded-xl border border-gold/10 bg-gold/[0.03] p-4 text-center lg:flex lg:items-center lg:gap-4 lg:text-left">
              {isEnterprise ? (
                <Briefcase size={18} className="mx-auto mb-1 text-burgundy/50 lg:mx-0 lg:mb-0" />
              ) : (
                <Users size={18} className="mx-auto mb-1 text-burgundy/50 lg:mx-0 lg:mb-0" />
              )}
              <div>
                <p className="text-xl font-bold text-ivory tabular-nums">
          ...
          {nextEvent && (
            <div className="rounded-xl border border-gold/20 bg-gradient-to-r from-gold/[0.06] to-transparent p-4">
        ...
        <div className="flex-1">
          ...
          <div className="mb-4 flex items-center justify-between">
            <h2 className="font-serif text-lg text-ivory/80">
              {isEnterprise ? "Staff Registry" : "Celebration Vault"}
            </h2>
            <Button
              variant="outline"
              size="sm"
          ...
          {events.length === 0 ? (
            <div className="flex flex-col items-center justify-center rounded-xl border border-dashed border-gold/10 py-16 text-center">
              ...
              <p className="mt-1 text-xs text-ivory/15">
                Tap &quot;Add Birthday&quot; to save your first celebration
              </p>
            </div>
          ) : (
